...
enum BuFiMotion {
    ...
    static let trackText = Animation.smooth(duration: 0.52, extraBounce: 0)
    static let trackPage = Animation.smooth(duration: 0.58, extraBounce: 0)
    static let miniTrack = Animation.smooth(duration: 0.48, extraBounce: 0)
