...
enum BuFiMotion {
    ...
    static let pressDown = Animation.snappy(duration: 0.09, extraBounce: 0)
    static let pressUp = Animation.spring(duration: 0.28, bounce: 0.16)
    static let symbol = Animation.spring(duration: 0.30, bounce: 0.14)
    ...
    static let trackArtwork = Animation.smooth(duration: 0.40, extraBounce: 0)
    static let trackPage = Animation.smooth(duration: 0.42, extraBounce: 0)
    ...
    static let miniLyrics = Animation.smooth(duration: 0.44, extraBounce: 0)
    static let lyrics = Animation.smooth(duration: 0.34, extraBounce: 0)
    static let lyricsPanel = Animation.spring(duration: 0.42, bounce: 0.08)
